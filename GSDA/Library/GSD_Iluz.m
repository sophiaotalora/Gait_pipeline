...
plot_results = true; %true = plot gait detection output, false = no plot is provided
...
try
    ...
    %GSD= struct('GaitSequence_Start',GSD(1).GaitSequence_Start,'GaitSequence_End',GSD(end).GaitSequence_Start,'GSD_fs',100); 
catch
