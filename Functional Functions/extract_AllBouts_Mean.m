function [WB_SDMO] = extract_AllBouts_Mean(imu,fs,WB_WBD,WB_SDMO,Settings,PlotSettings)
...
for WB_index = 1:WB_Number                                                  % loop over each WB
    ...
    % Outputs: mean WBs duration
    WB_SDMO(WB_index).Mean_WBDuration = nanmean(WalkingBoutDuration);
