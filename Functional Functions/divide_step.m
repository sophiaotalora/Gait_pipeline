        ...
        for iState = 1:length(MetaData.states)
            try
                ...
                for iSteps_per_SW = 1: SizeSW-1
                    ...
                    if (straightWalk_end < straightWalk_start) || (straightWalk_end-straightWalk_start<128)
                        continue;
                    end
                ...
                for iFirst_Last = 1:SizeSW-1 %If it is empty (since "continue" in line 15) then iFirst_Last + 1 
                    try
